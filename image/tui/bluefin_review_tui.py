...
def classify_review_action(
    ...
    *,
    ...
    if (
        ...
        and (not action_head or (FULL_SHA.fullmatch(action_head) and action_head == head_sha))
        and action_success
...
class ReviewDashboard(App):
    ...
    def _comparison_block(self, stop: Stop) -> str:
        ...
        return (
            ...
            f"{escape(receipt.repository)}#{receipt.number} · head {escape(receipt.reviewed_head[:12])} · "
